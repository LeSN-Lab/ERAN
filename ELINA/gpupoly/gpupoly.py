...
class Network:
    if os.name == 'nt': # Running in Windows
        os.add_dll_directory("/usr/local/cuda/bin")
        _lib = ctypes.cdll.LoadLibrary("/home/lesninha/Documents/AI2/ERAN/ELINA/gpupoly/gpupoly.dll")

    else: # Not running in Windows
        # _lib=ctypes.cdll.LoadLibrary('/home/lesninha/Documents/AI2/ERAN/ELINA/gpupoly/dpGPUlib.so.0.13')
